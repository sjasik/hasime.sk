class Storyline {
  ...
  changeSlide(index) {
    if (index === 0) {
      ...
      document.getElementById('feature1').style.opacity = 1
      ...
      document.getElementById('feature2').style.opacity = 1
      document.getElementById('feature3').style.display = "none"
    }
    else if (index === 2) {
      document.getElementById('feature1').style.display = "none"
      ...
      document.getElementById('feature3').style.opacity = 1

      setTimeout(reset, this.options.storyTime);
    }
  ...
  reset() {
    if (this.currentSlide = 2) {
      this.currentSlide = 0;
      this.indicators[1].classList.remove('item-loaded');
      this.indicators[2].classList.remove('item-loaded');
      this.indicators[2].classList.remove('item-loading');
      this.indicators[this.currentSlide].classList.remove('item-loaded');
      if (this.currentSlide === 0) {
        this.prev.setAttribute('disabled', 'true');
      }
